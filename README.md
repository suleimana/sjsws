...
These alternatives are much more advanced and you can do lot more with unsing them. However, they come with some complexities such as compatibility issues, having the need to implement custom interfaces, or its required to install some extra packages. A shell script, on the other hand, is easier to adapt to changing OS and Java environments.       
